...
```{r plot_ideam_stations, echo=FALSE, cache=TRUE, warnings=FALSE, messages=FALSE, error=FALSE, fig.cap="IDEAM Stations"}
#Conect PostgreSql
library("dplyr")
library("sf")
...
referencia a la figura \@ref(fig:plot_ideam_stations)
