...
```{r plotoneideamstation, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="IDEAM Station ELDORADO CATAM - AUT - Time Series", fig.width=4, fig.height=2.7}
...
plot.xts(statideam_xts, main = "Station ID: 21205791\nWind Velocity [m/s]", 
         ...
         legend.loc = "top", col="green", cex.main=0.3, cex=0.4, cex.axis=0.9,
         mar = c(2.5,1,0,1), oma = c(0,0,0,0))
#mtext(side = 1, text = "Station Name: ELDORADO CATAM - AUT", outer = TRUE, cex=0.2)
```
...
```{r plotoneisdstation, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="ISD Station ALFONSO BONILLA ARAGON INTL - Time Series", fig.width=4, fig.height=2.7}
...
ERA5 is forecast reanalysis data processed by the _European Centre for Medium-Range Weather Forecasts_ - ECMWF with wind speeds time series in square cells _matrix of pixels_ of 0.25 decimal degrees covering the whole planet. For the study area was extracted a raster of `r (nlat)` rows by `r nlon` columns in format netCDF. Figure \@ref(fig:plotera5stations) shows a map of ERA5 stations (cells centers).
