...
\subsection{Surface Roughness at Open Space (0.03 m)}\label{rmd-roughness}}
...
\hypertarget{datasources-comparison}{%
\section{Datasources comparison}\label{datasources-comparison}}

Looking for a statistical justification in the use of ISD (model) and ERA5 databases (forecast), as input data for this study, and considering the \emph{downscaling approach} described in the \protect\hyperlink{rmd-standartization}{standartization process} section of methodology, datasources ISD and IDEAM were standardized to enable comparison. Standardization consisted of transforming the data into 3-s gust \(V_3\), 10 meters height, and open space roughness.
\begin{itemize}
\item
  Variable \emph{10m wind gust - 10fg} of ERA5 datasource does not need standardization, because it comes standardized from the source
\item
...
\item
  Wind velocity \(V_5\) from 74 ISD stations, was standarized station by station, using procedure described in \protect\hyperlink{rmd-roughness}{Surface Roughness at Open Space} section, and \protect\hyperlink{rmd-gust}{Averaging Time 3-s Gust} section
\item
  Wind velocity from 12 \(V_{3600}\) (transformation of VV\_AUT\_2) IDEAM stations, was standarized station by station, using procedure described in \protect\hyperlink{rmd-roughness}{Surface Roughness at Open Space} section and \protect\hyperlink{rmd-gust}{Averaging Time 3-s Gust}
\end{itemize}
...
\end{itemize}
Stations 28025502 from IDEAM, 800360 from ISD, and 416 (cell with center point in \(-73.25^\circ\) longitude, and \(10.5^\circ\) latitude) from ERA5, showed high correspondence. See figures @ref(fig:s800360\_timeseries), @ref(fig:s800360\_ideam\_vs\_era5)
...
\hypertarget{non-hurrican-maps}{%
\section{Non-Hurrican Maps}\label{non-hurrican-maps}}
...
\hypertarget{hurrican-and-non-hurrican-maps}{%
\section{Hurrican and Non-Hurrican Maps}\label{hurrican-and-non-hurrican-maps}}
...
{\centering \includegraphics{thesis_files/figure-latex/page2-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page3-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page4-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page5-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page11-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page12-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page13-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page14-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/page15-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/test1-1} 
