...
\caption{\label{fig:verygoodxts}`Poor Data' Comparison: ERA5 vs ISD vs IDEAM. Downscaling Support: Graphics for `Very Good'}
\end{figure}
Hola
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/verygood-1.pdf}
\caption{\label{fig:verygood}`Poor Data' Comparison: ERA5 vs ISD vs IDEAM. Downscaling Support: Graphics for `Very Good'}
\end{figure}
