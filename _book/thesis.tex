...
Input data is made up of three different sources a) IDEAM - Institute of Hydrology, Meteorology and Environmental Studies of Colombia \textless www.ideam.gov.co\textgreater, b) ISD - Integrated Surface Database \url{https://www.ncdc.noaa.gov/isd}, and c) ERA5 climate reanalysis \url{https://www.ecmwf.int/en/forecasts/datasets/reanalysis-datasets/era5}.
...
\end{verbatim}
\includegraphics{thesis_files/figure-latex/plot_ideam_stations-1.pdf} \includegraphics{thesis_files/figure-latex/plot_ideam_stations-2.pdf}

referencia a la figura @ref(fig:plot\_ideam\_stations)
