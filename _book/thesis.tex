...
\caption{\label{fig:plotera5stations}ERA5 Stations (cells centers). Colombia bounding box}
\end{figure}
...
\caption{\label{fig:qualitycomparison2}Left: Twelve matching stations
...
\caption{\label{fig:poorcomparison}Left: Twelve matching stations
from IDEAM and ISD. Right: Stations 28025502 from IDEAM, 800360 from ISD, and 416 from ERA5}
\end{figure}
