...
\footnotesize
\begin{figure}
\includegraphics[width=6.81in]{figure/anemometer} \caption{Cross-sectional of multi-sensor automatic weather station, adapted from IDEAM (2005)}\label{fig:anemometer}
\end{figure}
\normalsize
