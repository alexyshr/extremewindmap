...
{\centering \includegraphics[width=2.46in]{figure/801120} 
...
\end{itemize}
After fitting the instensity function to the domain \(D\), the resulting parameters for ISD station 801120, are shown bellow:
\begin{itemize}
\item
  Location \(\omega_t\) equal to -56, and
\item
  Scale \(\psi_t\) equal to 23.
\end{itemize}
\begin{figure}
