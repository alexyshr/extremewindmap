#For declustered t dataset: create Data Statistics, check parameters using others methods, and Send to CSV
if (length(imp.vals$t.series.dt) > 0) {
  ...
  myextrRemes = alexys_exRtemes(imp.vals$t.series, threshold=t.thresh,
