...
plot_grid(myprint1, NULL, myprint5, ncol = 3,  rel_widths = c(1,0.25,1))
#grid.rect(gp=gpar(fill=NA))
...
* Location $\omega_t$ equal to `r format(z6, scientific=F, digits = 2)`, and 

* Scale $\psi_t$ equal to `r format(z7, scientific=F, digits = 2)`.
