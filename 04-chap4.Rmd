...
```{r verygoodxts, echo=FALSE, fig.cap="'Poor Data' Comparison: ERA5 vs ISD vs IDEAM. Downscaling Support: Graphics for 'Very Good'", message=FALSE, warning=FALSE, fig.height=3}
...
```{r verygood, echo=FALSE, fig.cap="'Poor Data' Comparison: ERA5 vs ISD vs IDEAM. Downscaling Support: Graphics for 'Very Good'", message=FALSE, warning=FALSE}
par(mfrow=c(3,2))
par(mar=c(0,0,0,0))
par(oma=c(0,0,0,0))
