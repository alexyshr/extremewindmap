...
```{r lettauvalues, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Lettau calculation. In red the area occupied by the obstacles, and in blue the perpendicular area. Source Triana (2019)", fig.align="center", dpi=150}
...
In this study, used intensity functions are shown in next Equation \@ref(eq:ppspecificintensityfunction).
