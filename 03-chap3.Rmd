...
```{r lettaustation2, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Digital imagery for 'Vanguardia' ISD station (USAF:802340), located in 'Villavicencio' airport. with four (south, north, east, and west) 45 degree sectors highlighted. Radius of the circular zone is 800 meters", size="footnotesize", fig.align="center", fig.width= 1.6, fig.height= 1.6}
