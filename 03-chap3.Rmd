...
```{r mainmethodology, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Iterative process in methodology", size="footnotesize", fig.align="center", fig.width= 2}
...
```{r anemometer, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Anemometer height - 10 m", fig.align="center"}
...
text(4,0, labels="Surface", pos=4, cex=0.8)
text(3.5,5.5, labels="10 meters", pos=4, cex=0.8)
text(4,11, labels="Anemometer", pos=4, cex=0.8)
...
```{r compassrose, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Wind rose with wind percentages in eight directions, for a generic station", fig.align="center", fig.width= 3, fig.height= 3}
...
lines(sectors, col="black", lwd=2)
lines(circle, col="black", lwd=2)
points(x=-73.614, y=4.168, pch=17, cex=2, col="red")
text(x=-73.614, y=4.168, labels="802340", pos=4, cex = 1.3, col="white")
...
```{r lettauexamples, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Roughness values: 0.03 for open space (left), 0.1 for closed space (center), and areas where Lettau equation is needed because roughness is different in each direction (right). From Triana (2019)", size="footnotesize", fig.align="center", fig.width= 4.5, fig.height= 1}
...
lines(sectors804070, col="black", lwd=1)
lines(circle804070, col="black", lwd=1)
points(x=-71.728, y=10.558, pch=17, cex=2, col="red")
...
lines(sectors803000, col="black", lwd=1)
lines(circle803000, col="black", lwd=1)
points(x=-77.9, y=2.583, pch=17, cex=2, col="red")
...
lines(sectors804380, col="black", lwd=1)
lines(circle804380, col="black", lwd=1)
points(x=-71.161, y=8.582, pch=17, cex=2, col="red")
text(x=-71.161, y=8.582, labels="804380", pos=2, cex = 1.3, col="black")
#box(which = "plot", col="red")
#box(which = "figure", col="blue")
#box(which = "inner", col="cyan")
#box(which = "outer", col="orange")
...
```{r lettauvalues, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Lettau calculation. In red the area occupied by the obstacles, and in blue the perpendicular area. Source Triana (2019)", size="footnotesize", fig.align="center", fig.width= 3}
